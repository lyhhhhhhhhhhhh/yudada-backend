package com.lking.yudada.controller;

import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.lking.yudada.annotation.AuthCheck;
import com.lking.yudada.common.BaseResponse;
import com.lking.yudada.common.DeleteRequest;
import com.lking.yudada.common.ErrorCode;
import com.lking.yudada.common.ResultUtils;
import com.lking.yudada.constant.UserConstant;
import com.lking.yudada.exception.BusinessException;
import com.lking.yudada.exception.ThrowUtils;
import com.lking.yudada.model.dto.userAnswer.UserAnswerAddRequest;
import com.lking.yudada.model.dto.userAnswer.UserAnswerEditRequest;
import com.lking.yudada.model.dto.userAnswer.UserAnswerQueryRequest;
import com.lking.yudada.model.dto.userAnswer.UserAnswerUpdateRequest;
import com.lking.yudada.model.entity.App;
import com.lking.yudada.model.entity.UserAnswer;
import com.lking.yudada.model.entity.User;
import com.lking.yudada.model.enums.ReviewStatusEnum;
import com.lking.yudada.model.vo.UserAnswerVO;
import com.lking.yudada.scoring.ScoringStrategyConfig;
import com.lking.yudada.scoring.ScoringStrategyExecutor;
import com.lking.yudada.service.AppService;
import com.lking.yudada.service.UserAnswerService;
import com.lking.yudada.service.UserService;
import com.lking.yudada.service.impl.AppServiceImpl;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        if (!ReviewStatusEnum.PASS.equals(ReviewStatusEnum.getEnumByValue(app.getReviewStatus()))) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR,"应用未通过审核，无法回答");
        }
        // 填充默认值
