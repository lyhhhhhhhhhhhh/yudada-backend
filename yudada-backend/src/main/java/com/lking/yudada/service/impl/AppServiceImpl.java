...
import com.lking.yudada.mapper.AppMapper;
...
import com.lking.yudada.model.enums.AppScoringStrategyEnum;
import com.lking.yudada.model.enums.AppTypeEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        // 精确查询
        queryWrapper.ne(StringUtils.isNotBlank(appIcon), "icon", appIcon);
